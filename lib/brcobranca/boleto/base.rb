...
module Brcobranca
  module Boleto
    ...
    class Base
      ...
      # <b>REQUERIDO</b>: Nosso número pronto
      attr_accessor :nosso_numero_gerado
      ...
      attr_accessor :logo_cedente
      # <b>REQUERIDO</b>: Logotipo do cedente
      attr_accessor :documento_cedente
      # <b>OPCIONAL</b>: Número sequencial utilizado para identificar o boleto
      attr_accessor :numero_documento
      # <b>OPCIONAL</b>: Número do documento que sairá na impressao
      attr_accessor :numero_documento_impresso
      ...
      # <b>OPCIONAL</b>: Exibe mensagem em vermelho
      attr_accessor :tarja

...
module Brcobranca
  module Boleto
    class Sicoob < Base # Sicoob (Bancoob)
      ...
      validates_length_of :prefixo, is: 1, message: 'deve ser igual a 1 dígito.'
      ...
      def initialize(campos = {})
        campos = { prefixo: '0', carteira: '1', variacao: '01', quantidade: '001' }.merge!(campos)
        super(campos)
      end
      ...
      def nosso_numero_boleto
        "#{prefixo}#{numero_documento}#{nosso_numero_dv}"
      end
      ...
      #
      def nosso_numero_dv
        "#{agencia}#{convenio.rjust(10, "0")}#{prefixo}#{numero_documento}".modulo11(
          reverse: false,
